  ...
  return (
    <tr
      className={cn(
        ...
        row.status.trim().toLowerCase() === "accept" &&
    ...
    >
      ...
      <td className="w-[12rem] max-w-[12rem] px-4 py-2.5 align-middle">
        {row.campaignId ? (
          <Link
            ...
            className="line-clamp-2 break-words font-medium text-blue-700 hover:underline dark:text-blue-300"
      ...
      <td className="px-4 py-2.5 align-middle text-center">
        {row.status.trim().toLowerCase().includes("reject") ? (
                      ...
                      <div className="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700">
                        ...
                        >
                          <div className="min-h-0 overflow-hidden">
                            <div
                              className={cn(
                                "overflow-x-auto border-t border-slate-200 transition-opacity duration-300 ease-out dark:border-slate-700",
                            ...
                            >
                              <table className="min-w-[64rem] w-full table-fixed text-sm">
                                {FILTER_LOG_COLGROUP}
                                <tbody>
                                  {activeFilterSection.postedRows.length > 0 ? (
                                    activeFilterSection.postedRows.map((row) => (
                                      <FilterLogDetailRow
                                        key={`posted-${row.id}`}
                                        row={row}
                                        onOpenLog={setLogRow}
                                    ...
                                    <tr>
                                      ...
                                      >
                                        No posted deliveries in this processing tree.
                                      </td>
                                    </tr>
                                  )}
                                </tbody>
