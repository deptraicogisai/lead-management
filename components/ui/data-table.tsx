            ...
            <tr>
              ...
              {columns.map((column) => {
                ...
                return (
                  <th
                    key={columnKey}
                    className="border-b border-slate-200 px-3 py-2 text-left text-xs font-semibold text-slate-700 sm:px-4 sm:py-2.5 dark:border-slate-600 dark:text-slate-100"
                  >
                    {columnSortable ? (
