...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 px-3 py-6 dark:bg-slate-950 sm:px-6 sm:py-8 lg:px-8">
      <div className="login-animate-shell mx-auto grid min-h-[calc(100vh-3rem)] max-w-6xl overflow-hidden rounded-[24px] border border-slate-800 bg-white shadow-2xl sm:rounded-[32px] dark:border-slate-700 dark:bg-slate-900 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <section className="flex items-center justify-center bg-white p-5 dark:bg-slate-900 sm:p-8 lg:p-10">
          <div className="w-full max-w-md">
            <LoginBrandMark className="login-animate-item mb-8 lg:mb-10" />

            <div className="login-animate-item login-animate-delay-2 mb-8 text-center sm:text-left">
